<%-- 
    Document   : booking
    Created on : Feb 10, 2023, 12:30:30 AM
    Author     : ACER
--%>
...
<html>
    ...
    <body>
        ...
        <div class="container">
            <h1 style="font-weight: bold; font-size: 96px; text-align: center; color: #124DA3">
                <span class="span1">Booki</span><span class="span2">ng Mo</span><span class="span3">tel</span><span class="span1"> R</span><span class="span2">oo</span><span class="span3">m</span>
            </h1><br><br>
            <div class="row">
